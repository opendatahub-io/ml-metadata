...
::grpc::Status MetadataStoreServiceImpl::GetArtifactsByID(
  ...
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->GetArtifactsByID(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetExecutionsByID(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->GetExecutionsByID(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::PutEvents(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->PutEvents(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetEventsByArtifactIDs(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->GetEventsByArtifactIDs(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetEventsByExecutionIDs(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->GetEventsByExecutionIDs(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetArtifactsByType(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->GetArtifactsByType(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetArtifactByTypeAndName(
  ...
  const ::grpc::Status transaction_status = ToGRPCStatus(
      metadata_store->GetArtifactByTypeAndName(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetArtifactsByExternalIds(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status = ToGRPCStatus(
      metadata_store->GetArtifactsByExternalIds(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetExecutionsByExternalIds(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status = ToGRPCStatus(
      metadata_store->GetExecutionsByExternalIds(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetContextsByExternalIds(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status = ToGRPCStatus(
      metadata_store->GetContextsByExternalIds(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetExecutionByTypeAndName(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status = ToGRPCStatus(
      metadata_store->GetExecutionByTypeAndName(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetContextsByID(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->GetContextsByID(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
...
::grpc::Status MetadataStoreServiceImpl::GetContextByTypeAndName(
  ...
  const std::multimap<grpc::string_ref, grpc::string_ref> MetadataContext =
        context->client_metadata();
  const ::grpc::Status transaction_status =
      ToGRPCStatus(metadata_store->GetContextByTypeAndName(&MetadataContext, *request, response));
  if (!transaction_status.ok()) {
