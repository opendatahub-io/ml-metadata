...
#define METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(method)      \
  ...
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(PutParentContexts)
  ...
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetContextsByArtifact)
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetContextsByExecution)
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetParentContextsByContext)
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetChildrenContextsByContext)
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetParentContextsByContexts)
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetChildrenContextsByContexts)
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetArtifactsByContext)
  METADATA_STORE_SERVICE_INTERFACE_DECLARE_2(GetExecutionsByContext)
