...
setup(
    ...
    author_email='mmortari@redhat.com',
    license='Apache 2.0',
    classifiers=[
    ...
    description='A remote-only, gRPC-only, MLMD Python client variant.',
    long_description=_LONG_DESCRIPTION,
    long_description_content_type='text/markdown',
    keywords='MLMD machine learning metadata tfx',
    url='https://github.com/opendatahub-io/ml-metadata',
    download_url='https://github.com/opendatahub-io/ml-metadata/tags',
    requires=[],
    cmdclass={
